...
$(function() {
    ...
    $("#registration-form").submit(function(e) {
        ...
        httpRequest.open("POST", "./index.php?action=checkEmail");
        httpRequest.onreadystatechange = function() {
            // The state 4 is considered as DONE.
            // src.: https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest/readyState
            if (httpRequest.readyState == 4) {
                // If the request succeeds, Apigility might return
                // a 200 or // 201.
                if (httpRequest.status.toString().indexOf("2") != 0) {
                    return;
                }
        ...
        httpRequest.send(JSON.stringify({ "email": document.getElementById("email").value }));
    });
